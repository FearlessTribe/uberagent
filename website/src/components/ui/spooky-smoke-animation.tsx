...
void main(){
  ...
  col=mix(vec3(.098,.11,.129),col,min(time*.1,1.));
  col=clamp(col,.08,1.);
  O=vec4(col,1);
}`;
...
/** Design-system default: --color-primary */
export const DEFAULT_SMOKE_COLOR = "#CC8066";
...
export function SmokeBackground({
  ...
  return (
    <div ref={rootRef} className={`relative h-full w-full ${className ?? ""}`}>
      <div
        className="absolute inset-0 hidden [background:radial-gradient(ellipse_70%_55%_at_65%_40%,rgba(204,128,102,0.18)_0%,transparent_60%),radial-gradient(ellipse_50%_45%_at_25%_75%,rgba(51,65,85,0.22)_0%,transparent_55%),var(--color-surface)] motion-reduce:block"
        aria-hidden
      />
